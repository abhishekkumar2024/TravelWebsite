...
export default function LoginModal({ isOpen, onClose, onLoginSuccess }: LoginModalProps) {
    ...
    const handleMicrosoftLogin = async () => {
        ...
        try {
            const { error: msError } = await supabase.auth.signInWithOAuth({
                provider: 'azure',
                options: {
                    redirectTo: `${window.location.origin}/submit`,
                },
            ...
            setError(err.message || t('Microsoft login failed', 'Microsoft लॉगिन विफल'));
            setLoading(false);
        }
    };
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 md:p-8 relative">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    >
                        ...
                        {t('Continue with Microsoft', 'Microsoft के साथ जारी रखें')}
                    </button>
                </div>
