...
<img src="https://images.unsplash.com/photo-1477587458883-47145ed94245?w=800" alt="Hawa Mahal" />
...
<p>अपनी जयपुर यात्रा की शुरुआत प्रतिष्ठित <strong>हवा महल</strong> से करें। इस शानदार गुलाबी बलुआ पत्थर की संरचना में 953 छोटी खिड़कियां हैं।</p>`,
        destination: 'jaipur',
        category: 'City Guide',
        coverImage: 'https://images.unsplash.com/photo-1477587458883-47145ed94245?w=600',
...
<p>उदयपुर को अक्सर भारत का सबसे रोमांटिक शहर कहा जाता है।</p>`,
        ...
        coverImage: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=600',
...
<p>जैसलमेर थार रेगिस्तान से एक सुनहरे मृगतृष्णा की तरह उभरता है।</p>`,
        ...
        category: 'Adventure',
        coverImage: 'https://images.unsplash.com/photo-1518623001395-125242310d0c?w=600',
...
<p>जोधपुर का पुराना शहर नीले रंग के घरों की एक भूलभुलैया है।</p>`,
        destination: 'jodhpur',
        category: 'City Guide',
        coverImage: 'https://images.unsplash.com/photo-1529154036614-a60975f5c760?w=600',
...
<p>पुष्कर भारत के सबसे पुराने शहरों में से एक है।</p>`,
        destination: 'pushkar',
        category: 'Spiritual',
        coverImage: 'https://images.unsplash.com/photo-1603204077779-bed963ea7d0e?w=600',
...
export const demoDestinations: Destination[] = [
    ...
    },
    {
        ...
        coverImage: 'https://images.unsplash.com/photo-1615836245337-f5b9b2303f10?q=80&w=1600&auto=format&fit=crop',
    ...
    },
    {
        ...
        coverImage: 'https://images.unsplash.com/photo-1590766940554-634a7ed41450?q=80&w=1600&auto=format&fit=crop',
    ...
    },
    {
        ...
        coverImage: '/images/mount-abu.jpg',
